...
export function HomeScreen({
  ...
  // مزامنة الحقل حين تتغيّر q من خارج هذا المكوّن — مثلاً SearchBar لسطح
  // المكتب، المُحمَّل دومًا بجانب هذا المكوّن ومخفيّ بالـ CSS فقط، ينفّذ بحثه
  ...
  // بحث حيّ (مُؤخَّر) — يطابق سلوك SearchBar الحالي على سطح المكتب. تُستثنى
  // query من الاعتماديات عمدًا — راجع تأثير المزامنة أعلاه الذي يُبقي search

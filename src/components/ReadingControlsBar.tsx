...
// ─────────────────────────────────────────────────────────────────────────────
// بار أدوات القراءة المشترك: سطوع الشاشة + حجم خط النشيد. يُستخدم في صفحتَي عرض
// الوصلة (المتصلة) وفي مرآة القراءة دون اتصال، فتبقى التجربة موحّدة أونلاين وأوفلاين.
// ─────────────────────────────────────────────────────────────────────────────
